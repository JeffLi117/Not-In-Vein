...
export default function page() {
  return (
    <div className="bg-red-200 md:h-[calc(100vh-74px)] p-4 flex justify-center items-start">
        <div className="flex flex-col justify-center items-center gap-4 md:w-1/2 text-center text-xl">
            ...
            <p>
                ...
                NIV can do that for you. We&apos;ll also be able to save important information such as your most visited locations, when you can next donate, and more.
            </p>
            <p>Sign up today!</p>
            <WhyDonate />
        </div>
